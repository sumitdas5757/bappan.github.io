            ...
            <div class="about_achievements-right">
                ...
                <div class="achievements_cards">
                    <article class="achievement_card">
                        ...
                        <h4>CLASS 09</h4>
                        <a href="haryanaboard/class9.php" class="boton">Select</a>
                    </article>
                    <article class="achievement_card">
                        <span class="achievement_icon">
                        ...
                        <h4>CLASS 10</h4>
                        <a href="haryanaboard/class10.php" class="boton">Select</a>
                    </article>
                    <article class="achievement_card">
                        <span class="achievement_icon">
                        ...
                        <h4>CLASS 11</h4>
                        <a href="haryanaboard/class11.php" class="boton">Select</a>
                    </article>
                    <article class="achievement_card">
                        <span class="achievement_icon">
                        ...
                        <h4>CLASS 12</h4>
                        <a href="haryanaboard/class12.php" class="boton">Select</a>
                    </article>
                </div>
            </div>
        </div>
