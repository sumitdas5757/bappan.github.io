...
<link rel="stylesheet" type="text/css" href="./cbse.css">
<style>
    body {
            ...
            <div class="about_achievements-right">
                ...
                <div class="achievements_cards">
                    <article class="achievement_card">
                        ...
                        <img src="../images/class12.png">
                        </span>
                        <h4>MATHEMATICS</h4>
                        <a href="../login.php" class="boton">Select</a>
                    </article>
                    <article class="achievement_card">
                        <span class="achievement_icon">
                        <img src="../images/class11.png">
                        </span>
                        <h4>BIOLOGY</h4>
                        <a href="../login.php" class="boton">Select</a>
                    </article>
                    ...
                    <article class="achievement_card">
                        ...
                        <h4>INFORMATIO PRACTICES</h4>
                        <a href="../login.php" class="boton">Select</a>
                    </article>
                    <article class="achievement_card">
                        <span class="achievement_icon">
                        <img src="../images/class02.png">
                        </span>
                        <h4>ENGLISH CORE</h4>
                        <a href="../login.php" class="boton">Select</a>
                    </article>
                    <article class="achievement_card">
                        <span class="achievement_icon">
                        <img src="../images/class01.png">
                        </span>
                        <h4>eNGLISH ELECTIVE NCERT</h4>
                        <a href="../login.php" class="boton">Select</a>
                    </article>
                    <article class="achievement_card">
                        <span class="achievement_icon">
                            <img src="../images/preschl.png">
                        </span>
                        <h4>HISTORY</h4>
                        <a href="../login.php" class="boton">Select</a>
                    </article>
                    ...
                    <article class="achievement_card">
                        ...
                        <h4>FINANCIAL MARKET MANAGEMENT</h4>
                        <a href="../login.php" class="boton">Select</a>
                    </article>
                    <article class="achievement_card">
                        <span class="achievement_icon">
                        ...
                        <h4>REASONING & MENTAL ABILITY</h4>
                        <a href="../login.php" class="boton">Select</a>
                    </article>
                    <article class="achievement_card">
                        <span class="achievement_icon">
