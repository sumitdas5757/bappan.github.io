            ...
            <div class="about_achievements-right">
                ...
                <div class="achievements_cards">
                    <article class="achievement_card">
                        ...
                        <h4>JEE MAIN</h4>
                        <a href="entrance/jee.php" class="boton">Select</a>
                    </article>
                    <article class="achievement_card">
                        <span class="achievement_icon">
                        <img src="images/neetd.png">
                        </span>
                        <h4>NEET-UG</h4>
                        <a href="entrance/neet.php" class="boton">Select</a>
                    </article>
                    <article class="achievement_card">
                        <span class="achievement_icon">
                        <img src="images/mht.png">
                        </span>
                        <h4>CUET (UG)</h4>
                        <a href="entrance/cuet.php" class="boton">Select</a>
                    </article>
                    <article class="achievement_card">
                        <span class="achievement_icon">
                        <img src="images/cuet.png">
                        </span>
                        <h4>MHT-CET</h4>
                        <a href="entrance/mht.php" class="boton">Select</a>
                    </article>
                    <article class="achievement_card">
                        <span class="achievement_icon">
                        <img src="images/jnv.png">
                        </span>
                        <h4>JNVST (CLASS-6)</h4>
                        <a href="entrance/jnvst.php" class="boton">Select</a>
                    </article>
                </div>
            </div>
        </div>
